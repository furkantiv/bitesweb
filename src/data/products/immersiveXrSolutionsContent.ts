...
export const immersiveXrSolutionsContent: ProductContent = {
  title: {
    en: "BİTES Immersive XR Solutions",
  ...
  sections: [
    ...
    },
    {
      type: "feature",
      image:
        "/images/products/productpages/training-simulation/immersive-xr-solutions/immersive-xr-2.png",
      heading: {
        en: "VR Supported Computer-Aided Exercise & Tactical Simulation",
        tr: "VR Destekli Bilgisayar Destekli Tatbikat & Taktik Simülasyonu",
      },
      content: {
        en: "Our immersive tactical simulation solutions combine VR technology, synthetic environments, and interactive scenario generation for mission readiness. Engage with computer-generated entities representing both threats and friendly forces in a rich, responsive 3D world.",
        tr: "Sürükleyici taktik simülasyon çözümlerimiz, görev hazırlığı için VR teknolojisi, sentetik ortamlar ve etkileşimli senaryo üretimi bir araya getirir. Gerçek zamanlı tehdit ve dost unsurları temsil eden bilgisayar tabanlı varlıklarla zengin, dinamik bir 3D ortamda etkileşime geçin.",
      },
      extra: {
        en: "Automatic/programmed or manually triggered scenario events, quick-launch mechanisms, and a user-friendly 3D scenario planning interface.",
