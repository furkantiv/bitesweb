...
const images = {
  join: `${basePath}/images/career/joinus.png`,
  criteria: `${basePath}/images/career/recruitment-criteria.png`,
...
export default function CareersPage() {
  return (
    ...
    >
      ...
      <motion.div
        variants={fadeInUp}
        className="rounded-2xl overflow-hidden relative mb-8 md:mt-10 h-[180px] md:h-[260px] lg:h-[320px]"
      >
        <Image
          src={images.join}
          alt="Join Us"
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div>
              ...
              >
                Click here for the minimum requirements we expect candidates to
                meet.
              </motion.p>
              <motion.ul
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div>
              ...
              >
                Discover our values, attractive benefits, fun office environment
                and development opportunities, as well as the opportunity to
