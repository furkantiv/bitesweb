  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20 md:px-0 md:pt-4 w-full min-h-screen bg-transparent flex flex-col lg:flex-row gap-8 justify-center">
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-black/50 border border-white/10 rounded-2xl p-6 md:p-10 flex flex-col gap-6">
          {/* Üst başlık ve meta */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="bg-white/10 text-xs text-white px-3 py-1 rounded-full border border-white/20 ml-1">
                {news.source}
              </span>
            </div>
          </div>
          ...
          {/* Büyük görsel */}
          <div className="w-full rounded-xl overflow-hidden border border-white/10 bg-black/20 shadow">
            <img
              src={news.image}
              alt={news.title}
