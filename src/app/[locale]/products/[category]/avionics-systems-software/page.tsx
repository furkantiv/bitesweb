...
import { avionicsSystemsContent } from "@/data/products/avionicsSystemsContent";
import { LocalizedStringArray } from "@/utils/types";
import { ArrowLeft } from "lucide-react";
import { useLocale, useTranslations } from "next-intl";
import Link from "next/link";

const AvionicsSystemsSoftware = () => {
  const content = avionicsSystemsContent;
  ...
  return (
    <div className="max-w-7xl px-5 my-20 md:my-40 mx-auto">
      <BackButton categorySlug="avionicsandmission" />
...
export default AvionicsSystemsSoftware;
