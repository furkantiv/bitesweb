...
import { karmaContent } from "@/data/products/karmaContent";

import { LocalizedStringArray } from "@/utils/types";
import { useLocale } from "next-intl";

const Karma = () => {
  const content = karmaContent;
  ...
  return (
    <div className="max-w-7xl my-20 md:my-40 mx-auto">
      ...
      <div className="px-3 md:px-6 pb-6 border rounded-2xl border-[#35434D] min-h-screen">
        <ProductHeader
