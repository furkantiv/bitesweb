...
import { shootingTrainingSimulatorContent } from "@/data/products/shootingTrainingSimulatorContent";
import { LocalizedStringArray } from "@/utils/types";
import { useLocale } from "next-intl";

const ShootingTrainingSimulator = () => {
  const content = shootingTrainingSimulatorContent;
...
export default ShootingTrainingSimulator;
