...
import { virtualMaintenanceSimulatorsContent } from "@/data/products/virtualMaintenanceSimulatorsContent";
import { LocalizedStringArray } from "@/utils/types";
import { useLocale } from "next-intl";

const VirtualMaintenanceSimulators = () => {
  const content = virtualMaintenanceSimulatorsContent;
...
export default VirtualMaintenanceSimulators;
