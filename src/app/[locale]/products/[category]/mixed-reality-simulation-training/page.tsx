...
import { mixedRealitySimulationTrainingContent } from "@/data/products/mixedRealitySimulationTrainingContent";
...
export default function Page() {
  const content = mixedRealitySimulationTrainingContent;
