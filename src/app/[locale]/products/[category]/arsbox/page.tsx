...
import { augmentedRealitySandBoxContent } from "@/data/products/arsbox";
import { LocalizedStringArray } from "@/utils/types";
import { useLocale } from "next-intl";

const ArsBox = () => {
  const content = augmentedRealitySandBoxContent;
  ...
  return (
    <div className="max-w-7xl my-20 md:my-40 mx-auto">
      ...
      <div className="px-6 border rounded-2xl border-[#35434D] min-h-screen">
        <ProductHeader
